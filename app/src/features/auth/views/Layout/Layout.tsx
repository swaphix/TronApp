    ...
    <div className="body-back-ground  flex flex-col sm:overflow-auto w-screen h-screen items-center justify-start sm:justify-start">
      ...
      <div className="relative h-auto sm:h-3/4 sm:mt-5 flex w-full flex-row items-center justify-center">
        ...
        <div className="bg-globalWhite flex flex-col justify-between items-center h-full  m-0 p-0 sm:mt-20 w-full sm:my-5 md:w-2/4 lg:w-3/6  sm:rounded-xl  sm:mb-10 ">
          ...
          {main.isBack?<BackArrow />:<div className=""></div>}
          <div className="h-full m-0 w-full px-5 md:overflow-auto sm:px-20 ">

          {/* <div className="md:overflow-auto h-full md:px-10 px-1 mt-3"> */}
            {/* CONTENT ALL */}
            <Outlet />
          </div>
        </div>
      ...
      {/* <div className="abosulute  bottom-0"> */}
